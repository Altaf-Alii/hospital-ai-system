...
function Appointments() {
  ...
  const fetchAppointments = async () => {
    try {
      const res = await axios.get('https://hospital-ai-system-production.up.railway.app/appointments/')
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editAppointment) {
        await axios.put(`https://hospital-ai-system-production.up.railway.app/appointments/${editAppointment.id}`, form)
      } else {
        await axios.post('https://hospital-ai-system-production.up.railway.app/appointments/', form)
      }
      setShowForm(false)
  ...
  const handleDelete = async (id) => {
    if (confirm('Delete this appointment?')) {
      await axios.delete(`https://hospital-ai-system-production.up.railway.app/appointments/${id}`)
      fetchAppointments()
    }
  }

  const updateStatus = async (id, status) => {
    await axios.put(`https://hospital-ai-system-production.up.railway.app/appointments/${id}`, { status })
    fetchAppointments()
  }
