...
function Patients() {
  ...
  const fetchPatients = async () => {
    try {
      const res = await axios.get('https://hospital-ai-system-production.up.railway.app/patients/')
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editPatient) {
        await axios.put(`https://hospital-ai-system-production.up.railway.app/patients/${editPatient.id}`, {
          ...form, age: parseInt(form.age)
        })
      } else {
        await axios.post('https://hospital-ai-system-production.up.railway.app/patients/', {
          ...form, age: parseInt(form.age)
        })
      }
      setShowForm(false)
  ...
  const handleDelete = async (id) => {
    if (confirm('Delete this patient?')) {
      await axios.delete(`https://hospital-ai-system-production.up.railway.app/patients/${id}`)
      fetchPatients()
    }
  }
